-- TODO make every class the same class with a different tostring return, tbh
-- TODO or DO I? Might need it like this for the future edit/new stuff
-- TODO yeah, keep them as is, move deciphering into classes though
